...
<form method="POST" action="{{route('movimentos.store')}}" novalidate class="form-group">
    ...
    <div class="form-group">
        ...
        <select name="aeronave" id="inputAeronave" class="form-control">
            ...
            @foreach ($aeronaves as $aeronave)
                <option {{ old('aeronave') == $aeronave->matricula ?"selected":"" }} value="{{$aeronave->matricula}}">{{$aeronave->matricula}} - {{$aeronave->marca}} {{$aeronave->modelo}}</option>
            @endforeach
        </select>
    ...
    <div class="form-group">
        ...
        <input
            ...
            placeholder="Nº de Diário" value="{{ old('num_diario') }}" />
    ...
    <div class="form-group">
        ...
        <input
            ...
            placeholder="Nº de Serviço" value="{{ old('num_servico') }}" />
        ...
        <div class="form-group">
            ...
            <select name="piloto_id" id="inputPilotoID" class="form-control">
                ...
                @foreach ($pilotos as $piloto)
                    <option {{ old('piloto_id') == $piloto->id ?"selected":"" }} value="{{$piloto->id}}">{{$piloto->num_socio}} - {{$piloto->nome_informal}}</option>
                @endforeach
            </select>
    ...
    @else
        <div class="form-group">
            ...
            <input
                ...
                name="piloto_id" value="{{$pilotos->id}}" />
        </div>
    @endif
    <div class="form-group">
        ...
        <select name="natureza" id="inputNatureza" class="form-control">
            <option disabled selected> -- select an option -- </option>
            <option {{ old('natureza') == 'T' ?"selected":"" }} value="T">Treino</option>
            <option {{ old('natureza') == 'I' ?"selected":"" }} value="I">Instrução</option>
            <option {{ old('natureza') == 'E' ?"selected":"" }} value="E">Especial</option>
        </select>
    ...
    <div class="form-group">
        ...
        <select name="aerodromo_partida" id="inputAerodromoPartida" class="form-control">
            ...
            @foreach ($aerodromos as $aerodromo)
                <option {{ old('aerodromo_partida') == $aerodromo->code ?"selected":"" }} value="{{$aerodromo->code}}">{{$aerodromo->nome}}</option>
            @endforeach
        </select>
    ...
    <div class="form-group">
        ...
        <select name="aerodromo_chegada" id="inputAerodromoChegada" class="form-control">
            <option disabled selected> -- select an option -- </option>
            @foreach ($aerodromos as $aerodromo)
                <option {{ old('aerodromo_chegada') == $aerodromo->code ?"selected":"" }} value="{{$aerodromo->code}}">{{$aerodromo->nome}}</option>
            @endforeach
        </select>
    ...
    <div class="form-group">
        ...
        <input
            ...
            placeholder="Nº de Aterragens" value="{{ old('num_aterragens') }}" />
    ...
    <div class="form-group">
        ...
        <input
            ...
            placeholder="Nº de Descolagens" value="{{ old('num_descolagens') }}" />
    ...
    <div class="form-group">
        ...
        <input
            ...
            placeholder="Nº de Pessoas a Bordo" value="{{ old('num_pessoas') }}" />
    ...
    <div class="form-group">
        ...
        <input
            ...
            placeholder="Conta-Horas Inicial" value="{{ old('conta_horas_inicio') }}"/>
    ...
    <div class="form-group">
        ...
        <input
            ...
            placeholder="Conta-Horas Final" value="{{ old('conta_horas_fim') }}"/>
    ...
    <div class="form-group">
        ...
        <input
            ...
            placeholder="Tempo de Voo" value="{{ old('tempo_voo') }}"/>
    ...
    <div class="form-group">
        ...
        <input
            ...
            placeholder="Preço do Voo" value="{{ old('preco_voo') }}" />
    ...
    <div class="form-group">
        ...
        <select name="modo_pagamento" id="inputModoPagamento" class="form-control">
            <option disabled selected> -- select an option -- </option>
            <option {{ old('modo_pagamento') == 'N' ?"selected":"" }} value="N">Numerário</option>
            <option {{ old('modo_pagamento') == 'M' ?"selected":"" }} value="M">Multibanco</option>
            <option {{ old('modo_pagamento') == 'T' ?"selected":"" }} value="T">Transferência</option>
            <option {{ old('modo_pagamento') == 'P' ?"selected":"" }} value="P">Pacote de Horas</option>
        </select>
    ...
    <div class="form-group">
        ...
        <input
            ...
            placeholder="Nº de Recibo" value="{{ old('num_recibo') }}" />
    ...
    <div class="form-group">
        ...
        <select name="tipo_instrucao" id="inputTipoInstrucao" class="form-control">
            <option disabled selected> -- select an option -- </option>
            <option {{ old('tipo_instrucao') == 'D' ?"selected":"" }} value="D">Duplo Comando</option>
            <option {{ old('tipo_instrucao') == 'S' ?"selected":"" }} value="S">Solo</option>
        </select>
    ...
    <div class="form-group">
        ...
        <select name="instrutor_id" id="inputInstrutorID" class="form-control">
            ...
            @foreach ($instrutores as $instrutor)
                <option {{ old('instrutor_id') == $instrutor->id ?"selected":"" }} value="{{$instrutor->id}}">{{$instrutor->num_socio}} - {{$instrutor->nome_informal}}</option>
            @endforeach
        </select>
